                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:10px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:28px 32px;color:#333333;font-size:15px;line-height:1.6;">
                            ...
                            <div style="margin-top:22px;padding:16px 18px;background:#fafafa;border-left:3px solid #f0a020;border-radius:4px;">
                                <div style="color:#8a8a8a;font-size:12px;text-transform:uppercase;letter-spacing:.5px;margin-bottom:8px;">
                                    Message
                                </div>
                                <div style="font-size:14px;color:#222222;line-height:1.65;">
                                    {!! nl2br(e($fields['message'])) !!}
                                </div>
                            </div>
