...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — BlogAdmin</title>
...
<nav id="sidebar">
    ...
    <?php $pendingComments = \App\Models\Comment::where('is_approved',false)->count(); ?>

    <div class="sb-section">Main</div>
    <a href="<?php echo e(route('admin.dashboard')); ?>" class="sb-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>"><i class="bi bi-speedometer2"></i> Dashboard</a>

    <div class="sb-section">Content</div>
    <a href="<?php echo e(route('admin.posts.index')); ?>" class="sb-link <?php echo e(request()->routeIs('admin.posts.*') ? 'active' : ''); ?>"><i class="bi bi-file-earmark-text"></i> Posts</a>
    <a href="<?php echo e(route('admin.categories.index')); ?>" class="sb-link <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>"><i class="bi bi-folder2-open"></i> Categories</a>
    <a href="<?php echo e(route('admin.tags.index')); ?>" class="sb-link <?php echo e(request()->routeIs('admin.tags.*') ? 'active' : ''); ?>"><i class="bi bi-tags"></i> Tags</a>
    <a href="<?php echo e(route('admin.comments.index')); ?>" class="sb-link <?php echo e(request()->routeIs('admin.comments.*') ? 'active' : ''); ?>">
        <i class="bi bi-chat-dots"></i> Comments
        <?php if($pendingComments > 0): ?><span class="sb-badge"><?php echo e($pendingComments); ?></span><?php endif; ?>
    </a>
    <a href="<?php echo e(route('admin.media.index')); ?>" class="sb-link <?php echo e(request()->routeIs('admin.media.*') ? 'active' : ''); ?>"><i class="bi bi-images"></i> Media</a>

    <div class="sb-section">Users</div>
    <a href="<?php echo e(route('admin.users.index')); ?>" class="sb-link <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>"><i class="bi bi-people"></i> All Users</a>

    <div class="sb-section">Developer</div>
    <a href="<?php echo e(route('api.docs')); ?>" target="_blank" class="sb-link"><i class="bi bi-braces-asterisk"></i> API Docs</a>
    ...
    <div class="mt-auto p-3" style="border-top:1px solid rgba(255,255,255,.06)">
        <div class="d-flex align-items-center gap-2 mb-2">
            ...
            <div>
                <div class="text-white" style="font-size:.82rem;line-height:1.2"><?php echo e(auth()->user()->name); ?></div>
                <div style="font-size:.7rem;color:#555d6b"><?php echo e(ucfirst(auth()->user()->role)); ?></div>
            </div>
        </div>
...
<header id="topbar">
    ...
    <div class="ms-auto d-flex align-items-center gap-2">
        ...
        <a href="<?php echo e(route('admin.comments.index')); ?>" class="topbar-btn position-relative text-decoration-none">
            <i class="bi bi-bell fs-5 text-muted"></i>
            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size:.6rem"><?php echo e($pendingComments); ?></span>
        </a>
        <?php endif; ?>
        <a href="<?php echo e(route('admin.posts.create')); ?>" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg me-1"></i>New Post</a>
    </div>
</header>
...
<?php /**PATH G:\xampp\htdocs\laravel-blog\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>