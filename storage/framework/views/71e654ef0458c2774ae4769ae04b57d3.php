...
<nav class="sidebar">
    ...
    <div class="p-3 mt-3" style="border-top:1px solid #30363d">
        ...
        <div class="cb p-2" style="font-size:.72rem"><?php echo e(config('app.url')); ?>/api</div>
    </div>
</nav>
...
async function getPosts() {
  const res = await fetch('<?php echo e(config('app.url')); ?>/api/posts', { next: { revalidate: 60 } });
  return res.json();
}
...
<?php /**PATH G:\xampp\htdocs\laravel-blog\resources\views/api/docs.blade.php ENDPATH**/ ?>